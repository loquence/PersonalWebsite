            ...
            <div className="footer">
                <div className="container">
                    ...
                    <div className="col-12 col-sm-4 align-self-center">
                            <br />
                            <h4 align="center" class="aboutme">Contacts: </h4>
                            <div className="text-center">
                                <a className="btn btn-social-icon btn-linkedin m-1" 
                                href="www.linkedin.com/in/ryan-kennedy-cs" id="linkedin"><i className="fa fa-linkedin"></i></a>
